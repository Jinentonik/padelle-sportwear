...
const MainPic = () => {
    return( 
            <Row>
                <Row style = {{height: "95vh", overflow:"hidden"}} className = "d-none d-md-block ">
                    <img src = {Img2} style = {{width: "100%", postion: "relative"}}></img> 
                ...
                <Row style = {{height: "30vh", overflow:"hidden"}} className = "d-block d-md-none">
                    <img src = {Img2} style = {{width: "100%", postion: "relative"}}></img> 
                    <div style = {{width: "40%", position: "absolute", top: "15%", right:"5%", color: "white"}}>
